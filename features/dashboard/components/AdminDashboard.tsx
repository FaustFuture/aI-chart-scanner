...
import { PastSetups } from "./PastSetups";
					...
					<Tabs defaultValue="generate" className="w-full">
						...
						<TabsContent value="generate" className="mt-6">
							<div className="flex flex-col gap-4">
									...
									<>
										<div className="mt-4 p-4 bg-[#212121] rounded-lg border border-[#424242]">
											<div className="flex justify-between items-center mb-2">
												<h3 className="text-[22px] font-semibold text-white">Your Trade Analysis</h3>
												<button
													type="button"
								...
								{isTradeSetupLoading && !tradeSetup && <TradeSetupSkeleton />}
								{error && (
						...
						<TabsContent value="history" className="mt-6">
							<PastSetups companyId={companyId} />
						</TabsContent>
					</Tabs>
				</div>
			)}
